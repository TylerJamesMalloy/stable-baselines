...
for tag in tag_strings:
    for agent_id in agents: #range(NUM_AGENTS):
        for resample_num in range(NUM_RESAMPLES):
            ...
            #clac_data = clac_data.iloc[-50:]
            #sac_data = sac_data.iloc[-50:]
...
ax = sns.boxplot(x="Resample", y="Episode Reward", hue="Model", data=All_Data)  # RUN PLOT   
#ax.set_ylim(-150,-100)
