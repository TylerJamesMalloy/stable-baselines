...
No acknowledgements, maintainers, or members listed in the original stable baseline citation are related to the group that submitted the NeurIPS paper, their names are left in as to maintain the complete original installation instructions and readme.
